...
def validate_login():
    ...
    if form.validate_on_submit():
        ...
        if user_obj:
            ...
            encode_pass = upass.encode('utf-8')
            print("6"*50)
            print(encode_pass)
            print("6"*50)
            (upass)
            ...
            print(bcrypt.check_password_hash(user_obj.password, form.password.data))
            print("?"*50)
            # print(check)
...
def edit_user_acct():
    ...
    if request.method == "POST":
        ...
        new_password = request.form.get("password-text-input")
        ...
        if new_password:
            if len(new_password) > 20:
                ...
                update_password = crud.update_user_password(session['user_id'], new_password)
                print("-"*50)
                print(update_password)
                flash(f"Sucessfully updated password to {new_password}")
